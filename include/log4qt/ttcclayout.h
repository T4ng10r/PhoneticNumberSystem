...
namespace Log4Qt
{
	...
	class TTCCLayout : public Layout
	{
		 ...
		 */
		 ...
		 Q_PROPERTY(bool endLineSymbol READ endLineSymbol WRITE setEndLineSymbol)
	...
	public:
		...
		void setEndLineSymbol(bool endLineSymbol);
	...
	inline bool TTCCLayout::endLineSymbol() const
	{	return mEndLineSymbol;		}
	...
	inline void TTCCLayout::setEndLineSymbol(bool endLineSymbol)
	{	mEndLineSymbol = endLineSymbol;		
		updatePatternFormatter();	}
