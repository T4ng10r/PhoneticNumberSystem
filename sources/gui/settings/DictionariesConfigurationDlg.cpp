...
class CDictionariesConfigurationDlgPrivate : public LoggingBase
{
  public:
...
CDictionariesConfigurationDlgPrivate::CDictionariesConfigurationDlgPrivate(CDictionariesConfigurationDlg* ptrPublic)
...
{
    bool bResult = false;
    bResult      = QObject::connect(changeDictionaryDirButton, SIGNAL(clicked(bool)), m_ptrPublic,
                               SLOT(onSelectDictionaryDirectory()));
    logConnection(
        "CDictionariesConfigurationDlgPrivate::setConnections",
        "'changeDictionaryDirButton::clicked' with 'CDictionariesConfigurationDlg::onSelectDictionaryDirectory'",
        bResult);

    bResult = QObject::connect(m_ptrPublic, SIGNAL(onDictionaryDirectoryChanged()), gDataThread.get(),
                               SLOT(onScanDirectoryForDictionaries()));
    logConnection(
        "CDictionariesConfigurationDlgPrivate::setConnections",
        "'dictionariesConfiguration::onDictionaryDirectoryChanged' with 'gDataThread::onScanDirectoryForDictionaries'",
        bResult);

    bResult = QObject::connect(gDataThread.get(), SIGNAL(onDictionariesFilesRefreshed()), m_ptrPublic,
                               SLOT(onDictionariesFilesRefreshed()));
    ...
    bResult = QObject::connect(m_ptrPublic, SIGNAL(dictionarySelected()), gDataThread.get(), SLOT(onSetDictionary()));
    logConnection("CDictionariesConfigurationDlgPrivate::setConnections",
                  "'m_ptrPublic::onDictionarySelected' with 'gDataThread::onSetDictionary'", bResult);
}
void CDictionariesConfigurationDlgPrivate::setDictionaryFilesMenuActionConnection(QAction* action)
{
    bool bResult = false;
    bResult =
        QObject::connect(action, SIGNAL(triggered(bool)), m_ptrPublic, SLOT(onDictionaryFilesMenuActionToggled()));
    logConnection(
        "CDictionariesConfigurationDlgPrivate::setConnections",
        "'changeDictionaryDirButton::clicked' with 'CDictionariesConfigurationDlg::onSelectDictionaryDirectory'",
        bResult);
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
CDictionariesConfigurationDlg::CDictionariesConfigurationDlg(QWidget* parent)
    : QWidget(parent)
